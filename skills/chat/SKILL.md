...
description: >
  ...
  about APIs, hooks, capabilities, or upgrade patterns. build, scaffold, or generate a plugin or any plugin component, use this skill and
---

# Moodle Development — Claude Chat Skill

This skill encodes Moodle 4.5+ / Workplace 5.1 development expertise for use in Claude Chat.
